      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="p-6 border border-zinc-100 shadow-sm flex flex-row items-center justify-between gap-4 bg-white rounded-2xl">
          <div className="space-y-1">
            <span className="text-xs font-bold text-zinc-400 uppercase tracking-wider block">Total Donors</span>
            <h3 className="text-3xl font-black text-zinc-800 font-[family-name:var(--font-plus-jakarta-sans)]">{totalUsers}</h3>
          </div>
        ...
        <Card className="p-6 border border-zinc-100 shadow-sm flex flex-row items-center justify-between gap-4 bg-white rounded-2xl">
          <div className="space-y-1">
            <span className="text-xs font-bold text-zinc-400 uppercase tracking-wider block">Total Funding</span>
            <h3 className="text-3xl font-black text-zinc-800 font-[family-name:var(--font-plus-jakarta-sans)]">${totalFunding}</h3>
          </div>
        ...
        <Card className="p-6 border border-zinc-100 shadow-sm flex flex-row items-center justify-between gap-4 bg-white rounded-2xl">
          <div className="space-y-1">
            <span className="text-xs font-bold text-zinc-400 uppercase tracking-wider block">Total Requests</span>
            <h3 className="text-3xl font-black text-zinc-800 font-[family-name:var(--font-plus-jakarta-sans)]">{totalRequests}</h3>
          </div>
