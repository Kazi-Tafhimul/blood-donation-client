...
export default function CreateDonationRequestPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      toast.error(
        "Network interface error. Ensure port 5000 server is active.",
      );
    } finally {
          ...
          <Fieldset className="w-full space-y-8">
            <div>
              ...
              <Description className="text-sm text-slate-500 font-medium">
                Submit a blood donation request and connect with available
                donors
              </Description>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 w-full">
                ...
                >
                  <Label className="text-[14px] font-bold text-zinc-800">
                    Requester Name
                  </Label>
